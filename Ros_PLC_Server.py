...
data = pd.read_csv('/home/rosubuntu/ros2_ws/src/MiniProjekt/MiniProjekt/procssing_times_table.csv',sep=";")
...
HOST = "10.0.2.15" #172.20.66.38"  # Standard loopback interface address (localhost)
